...
(function(t,e)
{
	...
	L.Draw.Polyline=L.Draw.Feature.extend(
	{
		...
		{		
			...
			if(t.title=="Переместить")
			{
							return e.href="#rem",t.text&&(e.innerHTML=t.text),
				              t.title&&(e.title=t.title),
							  
					L.DomEvent.on(e,"click",t.callback,t.context),e
			}	
			else
			{
				return e.href="#",t.text&&(e.innerHTML=t.text),
				              t.title&&(e.title=t.title),
		 	
			
					L.DomEvent.on(e,"click",L.DomEvent.stopPropagation).on(e,"mousedown",L.DomEvent.stopPropagation).on(e,"dblclick",L.DomEvent.stopPropagation).on(e,"click",L.DomEvent.preventDefault).on(e,"click",t.callback,t.context),e
			 }
		...
		{
			for(var e,i,o=L.DomUtil.create("ul","leaflet-draw-actions"), s=75, a=t.length,n=a*s+(a-1), r=0;a>r;r++)e=L.DomUtil.create("li","",o),
			
			i=this._createButton({title:t[r].title,text:t[r].text,container:e,callback:t[r].callback,context:t[r].context}),
			  this._actionButtons.push({button:i,callback:t[r].callback});
			  
			 return o.style.width="200px",o
		},
		...
		_showActionsToolbar:function()
		{
			...
			this._actionsContainer.style.top=s+"px",0===t
		...
		_hideActionsToolbar:function()
		{
			...
			L.Tooltip=L.Class.extend(
			{
				...
				{
					return t.subtext=t.subtext||"",0!==t.subtext.length||this._singleLineLabel?t.subtext.length>0&&this._singleLineLabel&&(L.DomUtil.removeClass(this._container,"leaflet-draw-tooltip-single"),this._singleLineLabel=!1):(L.DomUtil.addClass(this._container,"leaflet-draw-tooltip-single"),this._singleLineLabel=!0),
					
					this._container.innerHTML=(t.subtext.length>0?'<span class="leaflet-draw-tooltip-subtext">'+t.subtext+"</span>"+"<br />":"")+"<span>"+t.text+"</span>",this
			...
			L.EditToolbar=L.Toolbar.extend( 
			{
										...
										options:{ edit:{ title:"Переместить",selectedPathOptions:null}  },  
										
										initialize:function(t){L.Toolbar.prototype.initialize.call(this,t),this._selectedFeatureCount=0},

										addToolbar:function(t){ var e=L.DomUtil.create("div","leaflet-draw-section"),i=0,o="leaflet-draw-edit";
										
																return this._toolbarContainer=L.DomUtil.create("div","leaflet-draw-toolbar leaflet-bar"),
																	   this._map=t,this.options.edit&&this._initModeHandler(new L.EditToolbar.Edit(t,{featureGroup:this.options.featureGroup,selectedPathOptions:this.options.edit.selectedPathOptions}),this._toolbarContainer,i++,o),
																	   this.options.remove&&this._initModeHandler(new L.EditToolbar.Delete(t,{featureGroup:this.options.featureGroup}),this._toolbarContainer,i++,o),
																	   this._lastButtonIndex=--i,
																	   this._actionsContainer=this._createActions([{title:"Сохранить.",text:"Сохранить",callback:this._save,context:this},{title:"Клините Отменить для возврата.",text:"Отменить",callback:this.disable,context:this}]),
																	   
																	   e.appendChild(this._toolbarContainer),
																	   e.appendChild(this._actionsContainer), e
																},
		...
		{
											statics:{TYPE:"edit"},
											includes:L.Mixin.Events,options:{selectedPathOptions:{color:"#fe57a1",opacity:.6,dashArray:"10, 10",fill:!0,fillColor:"#fe57a1",fillOpacity:.1}},
...
function runMultiple()
{
	...
	// $(".leaflet-draw-actions").show();  
	 $(".leaflet-draw-edit-edit").click();  
 	// $(".leaflet-marker-icon").addClass("leaflet-edit-marker-selected");  
